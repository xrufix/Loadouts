...
#define CARBINE_CCO        WEAPON(CARBINE,LASERPOINTER,CCO,"")
...
// SF CARBINES
#define RIFLE_RECON         WEAPON("UK3CB_BAF_L85A2_RIS_AFG","RKSL_optic_LDS",LASERPOINTER,"UK3CB_BAF_Silencer_L85")
#define RIFLE_UGL_RECON     WEAPON(RIFLE_UGL,"RKSL_optic_LDS",LASERPOINTER,"UK3CB_BAF_Silencer_L85")
...
#define DMR           WEAPON("UK3CB_BAF_L129A1_FGrip_Bipod",DMR_BIPOD,"UK3CB_BAF_TA648",LASERPOINTER)
#define MAG_DMR       ARR_1("20Rnd_762x51_Mag")

#define DMR_RECON     WEAPON("UK3CB_BAF_L129A1_FGrip_Bipod","UK3CB_BAF_Silencer_L115A3","UK3CB_BAF_TA648",LASERPOINTER)
...
#define AUTORIFLE            WEAPON("UK3CB_BAF_L110A2RIS","",RCO,"UK3CB_BAF_LLM_IR_Black")
...
#define AUTORIFLE_RECON      WEAPON("UK3CB_BAF_L86A3","UK3CB_BAF_Silencer_L85",LASERPOINTER,"RKSL_optic_LDS")
#define MAGS_AUTORIFLE_RECON ARR_4(MAG_RIFLE_RECON,10,MAG_RIFLE_RECON_TRACER,5)

#define MMG           WEAPON("UK3CB_BAF_L110_762","UK3CB_BAF_TA648","","")
#define MAGS_MMG      ARR_3("UK3CB_BAF_762_100Rnd",2,"UK3CB_BAF_762_100Rnd_T")
#define MAGS_MMG_ASST ARR_2("UK3CB_BAF_762_100Rnd",2)

/* ###################### - SIDEARMS - ###################### */
#define PISTOL		WEAPON("UK3CB_BAF_L131A1","","","")
#define PISTOL_SF	WEAPON("UK3CB_BAF_L131A1","hlc_muzzle_TiRant9S","UK3CB_BAF_Flashlight_L131A1","")

#define MAG_PISTOL 		ARR_1("UK3CB_BAF_9_17Rnd")
#define MAG_PISTOL_SF 	ARR_1("UK3CB_BAF_9_17Rnd")

/* ###################### - LAUNCHERS - ###################### */
#define AT_LIGHT	    WEAPON("UK3CB_BAF_AT4_CS_AT_Launcher","","","")
...
#define AT_MISSILE              WEAPON("UK3CB_BAF_Javelin_Launcher","","","")
